...
const seoMetadata: SEOMetadata = {
  ...
  description:
    'Professional corporate video production services in Morocco. Custom solutions for businesses across Casablanca, Rabat, and Mohammedia. Contact BlackWoods Creative for consultation.',
  keywords: [
  ...
  openGraph: {
    title: 'Corporate Video Production in Morocco | Professional Services',
    description:
      'Professional corporate video production services in Morocco. Custom solutions for businesses.',
    type: 'service',
  },
  structuredData: {
    '@type': 'Article',
...
const pageData: ServicePageData = {
  hero: {
    ...
    description:
      'Transform your corporate messaging with compelling video content. From company profiles to training videos, we create professional videos that engage your audience and drive results.',
    cta: {
    ...
    steps: [
      {
        ...
        description:
          'We discuss your objectives, target audience, and provide a detailed quote based on your specific needs.',
      },
      {
        number: '02',
        title: 'Script & Storyboard',
        description:
          'Professional script writing and visual planning to ensure your message is clear and engaging.',
      },
      {
        number: '03',
        title: 'Production Day',
        description:
          'Professional filming with experienced crew, quality equipment, and minimal disruption to your business.',
      },
      {
        number: '04',
        title: 'Post & Delivery',
        description:
          'Expert editing, graphics, and final delivery in all required formats for your distribution needs.',
      },
    ],
  },
  faq: [
    {
      ...
      answer:
        'Our corporate video production includes comprehensive pre-production planning, professional filming with high-quality equipment, expert post-production editing, and final delivery in your preferred formats. We handle everything from concept development to final delivery.',
    },
    {
      question: 'How do you handle multi-location corporate video shoots?',
      answer:
        'We have extensive experience with multi-location productions across Morocco. Our team coordinates logistics, equipment transport, and scheduling to ensure seamless production across different sites while maintaining consistent quality and messaging.',
    },
    {
      question: 'Do you provide consultation for corporate video strategy?',
      answer:
        'Yes, we offer comprehensive consultation services to help you develop an effective video strategy. We work with you to understand your objectives, target audience, and desired outcomes to create the most impactful video content for your business.',
    },
    {
      question: "What's the difference between HD and 4K production?",
      answer:
        "4K production offers superior image quality and future-proofing for your content. We recommend 4K for large screen presentations, detailed product showcases, and content that may be repurposed across multiple platforms. We'll help you choose the best format for your specific needs.",
    },
    {
      question: 'How do you ensure corporate video content aligns with our brand?',
      answer:
        'We begin every project with a thorough brand consultation to understand your visual identity, messaging, and corporate standards. Our team works closely with your marketing department to ensure all content maintains brand consistency and professional quality.',
    },
  ],
};
