...
const seoMetadata: SEOMetadata = {
  ...
  description:
    'Professional 3D visualization and rendering services in Morocco. Architectural visualization, product rendering, and 3D modeling. Serving Casablanca, Rabat, Mohammedia.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Expert 3D visualization and rendering services for architecture, products, and marketing in Morocco.',
    type: 'service',
  },
};
...
const pageData: ServicePageData = {
  hero: {
    ...
    description:
      'Professional 3D modeling, rendering, and visualization services that bring your ideas to life with stunning detail and accuracy.',
    breadcrumbs: [
      { label: 'Home', href: '/' },
  ...
  services: [
    {
      ...
      description:
        'Photorealistic 3D renderings of buildings, interiors, and developments that help clients visualize projects before construction.',
      features: [
    ...
    },
    {
      ...
      description:
        'Detailed 3D models and renderings of products for marketing, prototyping, and manufacturing purposes.',
      features: [
        'Product 3D modeling',
    ...
    },
    {
      ...
      description:
        'Dynamic 3D animations that showcase products, processes, or architectural spaces in engaging motion.',
      features: [
  ...
  process: [
    {
      ...
      description:
        'We analyze your project requirements, reference materials, and desired visual outcomes.',
    },
    {
      step: 2,
      title: '3D Modeling',
      description:
        'Creating detailed 3D models with accurate proportions, materials, and textures.',
    },
    {
      step: 3,
      title: 'Lighting & Rendering',
      description:
        'Professional lighting setup and high-quality rendering for photorealistic results.',
    },
    {
      step: 4,
      title: 'Post-Production & Delivery',
      description:
        'Final touches, color correction, and delivery in all required formats and resolutions.',
    },
  ],
  featuredAnswer: {
    question: 'What is 3D visualization and how can it benefit my business?',
    answer:
      '3D visualization creates photorealistic digital representations of products, buildings, or concepts before they exist physically. It helps businesses reduce costs, improve communication, accelerate approvals, and create compelling marketing materials that drive sales and engagement.',
    details: [
