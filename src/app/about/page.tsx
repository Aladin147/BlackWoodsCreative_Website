...
const seoMetadata = {
  ...
  description:
    'Discover the BlackWoods Creative story - Morocco&apos;s premier creative studio founded on visual excellence. Learn about BlackWoods&apos; journey, values, and commitment to exceptional creative services.',
  keywords: [
    'About BlackWoods',
  ...
  openGraph: {
    ...
    description:
      'Discover the BlackWoods Creative story - Morocco&apos;s premier creative studio founded on visual excellence and innovative storytelling.',
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-bw-bg-primary">
        ...
        <section className="via-bw-bg-secondary relative overflow-hidden bg-gradient-to-br from-bw-bg-primary to-bw-bg-primary py-32">
            ...
            <div className="text-center">
              ...
              <ScrollReveal delay={0.2}>
                <p className="mx-auto max-w-3xl font-primary text-body-xl text-bw-text-secondary">
                  Morocco&apos;s premier creative studio, founded on the belief that exceptional
                  visual storytelling can transform brands, captivate audiences, and drive
                  meaningful results.
                </p>
              </ScrollReveal>
            </div>
              ...
              <div className="lg:col-span-7">
                ...
                <ScrollReveal delay={0.2}>
                  <div className="space-y-6 font-primary text-body-xl">
                    <p>
                      BlackWoods Creative was born from a passion for visual excellence and a vision
                      to elevate Morocco&apos;s creative landscape. Founded by a team of dedicated
                      artists and storytellers, we&apos;ve grown into Morocco&apos;s leading
                      creative studio.
                    </p>
                    <p>
                      What sets BlackWoods apart is our unwavering commitment to quality,
                      innovation, and authentic storytelling. Every project we undertake reflects
                      our core belief that great creative work should not only look exceptional but
                      also drive real business results.
                    </p>
                    <p>
                      From our state-of-the-art facilities in Mohammedia to our collaborative
                      approach with clients across Morocco and beyond, BlackWoods Creative continues
                  ...
                  <ScrollReveal delay={0.4}>
                    <div className="card p-8 text-center">
                      ...
                      <div className="grid grid-cols-2 gap-6">
                        <div>
                          <div className="font-display text-display-lg font-bold text-bw-accent-gold">
                            500+
                          </div>
                          <div className="font-primary text-body-md text-bw-text-secondary">
                            Projects Completed
                          </div>
                        </div>
                        <div>
        ...
        <section className="bg-bw-bg-secondary py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
              ...
              <ScrollReveal delay={0.2}>
                <p className="mx-auto max-w-3xl font-primary text-body-xl text-bw-text-secondary">
                  BlackWoods Creative offers a comprehensive suite of creative services, all unified
                  by our commitment to exceptional quality and innovative storytelling.
                </p>
              </ScrollReveal>
            </div>

            <StaggeredGrid className="grid grid-cols-1 gap-8 md:grid-cols-3" staggerDelay={0.15}>
              <MagneticField strength={0.2} distance={120}>
                <div className="card group cursor-pointer text-center">
                  ...
                  <h3 className="mb-6 font-primary text-display-md">BlackWoods Video Production</h3>
                  <p className="font-primary text-body-xl">
                    From corporate videos to brand films, BlackWoods delivers cinematic quality that
              ...
              <MagneticField strength={0.2} distance={120}>
                <div className="card group cursor-pointer text-center">
                  ...
                  <h3 className="mb-6 font-primary text-display-md">BlackWoods Photography</h3>
                  <p className="font-primary text-body-xl">
                    Professional photography services that capture the essence of your brand with
                    BlackWoods&apos; signature attention to detail.
                  </p>
                </div>
              </MagneticField>
              ...
              <MagneticField strength={0.2} distance={120}>
                <div className="card group cursor-pointer text-center">
                  ...
                  <h3 className="mb-6 font-primary text-display-md">BlackWoods 3D Visualization</h3>
                  <p className="font-primary text-body-xl">
                    Cutting-edge 3D modeling and visualization that brings concepts to life with
        ...
        <section className="bg-bw-bg-secondary py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <RelatedLinks
        ...
        <section className="py-24">
          <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
            <ScrollReveal>
              <h2 className="mb-6 font-display text-display-lg text-bw-text-primary">
                Ready to Experience <span className="text-bw-accent-gold">BlackWoods</span>{' '}
                Creative?
              </h2>
            </ScrollReveal>
            <ScrollReveal delay={0.2}>
              <p className="mb-8 font-primary text-body-xl text-bw-text-secondary">
                Discover why leading brands choose BlackWoods Creative for their most important
                projects.
              </p>
            </ScrollReveal>
            <ScrollReveal delay={0.4}>
              <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
                ...
                <MagneticField strength={0.3} distance={100}>
                  <a
                    href="/portfolio"
                    className="rounded-lg border border-bw-border-subtle px-8 py-3 font-medium text-bw-text-primary transition-all duration-300 hover:scale-105 hover:bg-bw-border-subtle"
                  >
