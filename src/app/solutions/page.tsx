...
const seoMetadata = {
  ...
  description:
    'Discover BlackWoods Creative solutions for every industry and interest. From BlackWoods video production to BlackWoods photography and 3D visualization - find your perfect creative solution.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Explore BlackWoods Creative solutions tailored to your industry and interests. Professional video, photography, and 3D visualization services.',
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto max-w-3xl text-body-xl text-bw-text-secondary">
              Whatever your creative needs, BlackWoods has the perfect solution. Explore our
              comprehensive range of video, photography, and 3D services tailored to every industry
              and interest.
            </p>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-bw-bg-secondary rounded-lg p-8">
              ...
              <h3 className="text-display-sm mb-4 font-display text-bw-text-primary">
                BlackWoods Business Solutions
              </h3>
              ...
              <ul className="text-body-sm space-y-2 text-bw-text-secondary">
            ...
            <div className="bg-bw-bg-secondary rounded-lg p-8">
              ...
              <p className="mb-6 text-body-md text-bw-text-secondary">
                Creative marketing content that drives engagement, builds brand awareness, and
            ...
            <div className="bg-bw-bg-secondary rounded-lg p-8">
              ...
              <p className="mb-6 text-body-md text-bw-text-secondary">
                Stunning architectural visualization, property photography, and virtual tours that
            ...
            <div className="bg-bw-bg-secondary rounded-lg p-8">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-bw-accent-gold/10">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.5 5M7 13l2.5 5m0 0h7M9.5 18a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zm10 0a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"
                  />
                </svg>
              </div>
              <h3 className="text-display-sm mb-4 font-display text-bw-text-primary">
              ...
              <p className="mb-6 text-body-md text-bw-text-secondary">
                Professional product photography and videos that increase sales and improve customer
            ...
            <div className="bg-bw-bg-secondary rounded-lg p-8">
              ...
              <p className="mb-6 text-body-md text-bw-text-secondary">
                Comprehensive event coverage including live streaming, photography, and post-event
                content creation.
              </p>
              <ul className="text-body-sm space-y-2 text-bw-text-secondary">
            ...
            <div className="bg-bw-bg-secondary rounded-lg p-8">
              ...
              <p className="mb-6 text-body-md text-bw-text-secondary">
                Educational content creation including training videos, course materials, and
      ...
      <section className="bg-bw-bg-secondary py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-3xl text-body-lg text-bw-text-secondary">
              BlackWoods Creative solutions are trusted by leading companies across diverse
          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            ...
            <div className="text-center">
              ...
              <p className="text-body-sm text-bw-text-secondary">
                Developers, Agencies, Architects
              </p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-body-sm text-bw-text-secondary">
                E-commerce, Fashion, Consumer goods
              </p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-body-sm text-bw-text-secondary">
                Industrial, Automotive, Production
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mb-8 text-body-lg text-bw-text-secondary">
            Ready to discover how BlackWoods Creative can solve your specific challenges? Let&apos;s
            discuss your needs and create a custom solution.
          </p>
