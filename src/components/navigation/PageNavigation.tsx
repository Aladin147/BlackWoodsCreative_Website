...
const PAGE_SEQUENCES = {
  ...
  services: [
    ...
    {
      path: '/services/video-production-morocco',
      title: 'Video Production',
      description: 'Professional video services',
    },
    {
      path: '/services/corporate-video-production-morocco',
      title: 'Corporate Videos',
      description: 'Business video solutions',
    },
    {
    ...
    },
    {
      ...
      description: 'Stunning 3D rendering',
    },
  ],
};
...
export function PageNavigation({
  ...
  return (
    <nav
      className={`bg-bw-bg-secondary border-t border-bw-border-subtle ${className}`}
                  ...
                  <MagneticField strength={0.2} distance={100}>
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        <div className="font-medium text-bw-text-primary transition-colors group-hover:text-bw-accent-gold">
                          {prevPage.title}
                        </div>
              ...
              {relatedLinks.relatedPages.slice(0, maxRelated).map((link, index) => (
                <ScrollReveal key={link.href} delay={0.3 + index * 0.1}>
                  <MagneticField strength={0.15} distance={80}>
                    ...
                    >
                      <h4 className="font-medium text-bw-text-primary transition-colors group-hover:text-bw-accent-gold">
                        {link.text}
                      </h4>
                      {link.description && (
...
export function CompactPageNavigation({ className = '' }: { className?: string }) {
  ...
  return (
    <nav
      ...
      aria-label="Compact page navigation"
    >
      {prevPage ? (
        <Link
          href={prevPage.path}
...
export function SectionNavigation({
  ...
  return (
    <nav className={`sticky top-24 ${className}`} aria-label="Section navigation">
      <div className="bg-bw-bg-secondary rounded-lg border border-bw-border-subtle p-4">
