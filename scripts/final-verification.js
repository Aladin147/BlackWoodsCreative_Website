...
const LOGO_SVG_URL = 'https://www.blackwoodscreative.com/BLKWDS%20Creative%20Logo_Inverted.svg';
const LOGO_PNG_URL = 'https://www.blackwoodscreative.com/BLKWDS%20Creative%20Logo_inverted.png';
...
async function testFormspreeEndpoint() {
  ...
  const testData = {
    ...
    budget: '$10000+',
    message: 'Final verification test of the improved contact form with JSON format to avoid spam detection.',
...
function testApiCredentials() {
  ...
  console.log(`   ${masterKeyValid ? '✅' : '❌'} Master key format: ${masterKey.substring(0, 8)}...`);
  console.log(`   ${readonlyKeyValid ? '✅' : '❌'} Readonly key format: ${readonlyKey.substring(0, 8)}...`);
